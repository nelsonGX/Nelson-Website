...
const servers = [
  {
    ...
    images: Array.from({ length: 5 }, (_, i) => `/assets/images/minecraft/smpv1/${i + 1}.webp`),
    autoplayDelay: 3200,
    imageFirst: false,
  },
  {
    translationKey: 'nelsonSMPv2',
    images: Array.from({ length: 7 }, (_, i) => `/assets/images/minecraft/smpv2/${i + 1}.webp`),
    autoplayDelay: 2800,
    imageFirst: true,
  },
  {
    translationKey: 'MLGRush',
    images: Array.from({ length: 2 }, (_, i) => `/assets/images/minecraft/mlgrush/${i + 1}.webp`),
    autoplayDelay: 5000,
    imageFirst: false,
  },
  {
    translationKey: 'highschoolSMP',
    images: Array.from({ length: 4 }, (_, i) => `/assets/images/minecraft/highschoolsmp/${i + 1}.webp`),
    autoplayDelay: 3000,
    imageFirst: true,
  },
  {
    translationKey: 'nelsonSMPv3',
    images: Array.from({ length: 9 }, (_, i) => `/assets/images/minecraft/smpv3/${i + 1}.webp`),
    autoplayDelay: 2000,
    imageFirst: false,
  ...
  },
  {
    ...
    images: Array.from({ length: 5 }, (_, i) => `/assets/images/minecraft/smpv4/${i + 1}.webp`),
    autoplayDelay: 2700,
    imageFirst: true,
  },
  {
    translationKey: 'freeServerNetwork',
    images: Array.from({ length: 3 }, (_, i) => `/assets/images/minecraft/fsn/${i + 1}.webp`),
    autoplayDelay: 4000,
    imageFirst: false,

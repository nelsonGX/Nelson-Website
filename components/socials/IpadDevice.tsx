...
export const IpadDevice: React.FC<IpadDeviceProps> = ({
  ...
  return (
    <div className="hidden md:block relative w-[760px] h-[572px] lg:w-[800px] lg:h-[600px] rounded-2xl overflow-hidden bg-zinc-950 border-2 border-zinc-700 shadow-2xl">
      ...
      <div className="relative w-full h-full bg-cover bg-center bg-gradient-to-br from-blue-700/30 to-red-600/40">
        ...
        <div className="flex flex-col h-[calc(100%-32px)] justify-between">
          ...
          <div className="mt-auto flex justify-center pb-1">
            <div className="mx-auto bg-zinc-500 bg-opacity-20 backdrop-blur-md rounded-3xl p-3 flex justify-around gap-4 w-auto">
              {dockApps.map((app) => (

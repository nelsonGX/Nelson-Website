import { FaEnvelope, FaDiscord, FaTelegram, FaTwitter, FaGithub, FaInstagram, FaFacebook, FaReddit, FaTwitch, FaYoutube, FaPhone, FaSafari, FaComment, FaMusic, FaLinkedin } from 'react-icons/fa';
